...
- **Pr(IBD = 2)**: The probability that the identity by descent (IBD) is 2 in each relationship.

- **Pr(IBD = 1)**: The probability that the identity by descent (IBD) is 1 in each relationship.

- **Pr(IBD = 0)**: The probability that the identity by descent (IBD) is 0 in each relationship.
...
**Note** Information on the probabilities of IBD, paternal lineage, and maternal lineage in the new relationship is automatically determined based on your-defined family tree.
