...
- Minimum LR: The minimum likelihood ratio that the victim and reference profiles support the assumed relationship.

**Y-STR**

- Maximum number of mismatched loci: The upper limit of the number of mismatched loci between victim and reference profiles that the profiles support paternal lineage.

- Maximum total mutational steps: The upper limit of total mutational steps (i.e., sum of mutational steps of all loci) between victim and reference profiles that the profiles support paternal lineage.

**mtDNA**

- Maximum number of inconsistency: The upper limit of inconcistency between victim and reference profiles that the profiles support maternal lineage.
