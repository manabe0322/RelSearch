...
- Allele counts in the population database are entered in columns for each marker.
...
- The marker with an empty cell (e.g., DYS392 of the sample ‘Victim5’) is ignored for analysis.
...
- The marker with an empty cell (e.g., DYS518 of the sample ‘Reference5’) is ignored for analysis.
...
- In the 'Range' column, the first and the last positions in each readable sequence must be written with a hyphen between these positions (e.g, 73-340). Readable sequences must be separated by a single blank space.
...
- Empty cells in the 'Range' and 'Haplotype' columns (e.g., the sample ‘Victim5’) mean that there is no readable sequence.
...
- Empty cells in the 'Range' and 'Haplotype' columns (e.g., the sample ‘Reference5’) mean that there is no readable sequence.
