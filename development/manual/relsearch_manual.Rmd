...
The method of calculating the LR uses the probabilities that two, one and zero alleles are identity by descent (IBD). If allelic drop-out and mutations are not considered,  the LR is calculated according to the method of Wenk et al [@Wenk1996].

$$
Pr(G_{v}, G_{r}|H) = Pr(G_{v}, G_{r}|IBD = 2)Pr(IBD = 2) + Pr(G_{v}, G_{r}|IBD = 1)Pr(IBD = 1) + Pr(G_{v}, G_{r}|IBD = 0)Pr(IBD = 0)
$$
