...
You can set the following criteria. Press the **Save** button to reflect the changes. Press the **Reset** button if you want to return to default values.
...
- Maximum number of mismatched loci: How many loci do you allow for mismatches between victim and reference profiles

- Maximum number of ignored loci: RelSearch can ignore loci that indicates partial profiles

- Maximum total mutational steps

**mtDNA**

- Maximum number of inconsistency
