test_that("kinLike2 IBS = 0 pattern 1", {
  qgt <- 11
  rgt <- c(12, 12)
  ...
  likelihoods <- kinLike2(qgt, rgt, afOneL, afAlOneL, probIBD, mutation, myuOneL, apeOneL)
  expect_equal(likelihoods[1], 0.25 * 0.15^2 * 0.25^2)
  expect_equal(likelihoods[2], 0.15^2 * 0.25^2)
})

test_that("kinLike2 IBS = 0 pattern 2", {
  qgt <- c(11, 13)
  rgt <- c(12, 14)
  afOneL <- c(0.15, 0.25, 0.3, 0.25, 0.05)
  afAlOneL <- 11:15
...
test_that("kinLike2 IBS = 1 pattern 1", {
  qgt <- c(11, 12)
  rgt <- c(11, 13)
  afOneL <- c(0.15, 0.25, 0.3, 0.25, 0.05)
  afAlOneL <- 11:15
...
test_that("kinLike2 IBS = 1 pattern 2", {
  qgt <- c(11, 12)
  rgt <- c(12, 13)
  afOneL <- c(0.15, 0.25, 0.3, 0.25, 0.05)
  afAlOneL <- 11:15
...
test_that("kinLike2 IBS = 1 pattern 3", {
  qgt <- c(11, 11)
  rgt <- c(11, 13)
  afOneL <- c(0.15, 0.25, 0.3, 0.25, 0.05)
  afAlOneL <- 11:15
...
test_that("kinLike2 IBS = 1 pattern 4", {
  qgt <- c(13, 13)
  rgt <- c(11, 13)
  afOneL <- c(0.15, 0.25, 0.3, 0.25, 0.05)
  afAlOneL <- 11:15
...
test_that("kinLike2 IBS = 2 pattern 1", {
  qgt <- c(11, 11)
  rgt <- c(11, 11)
  afOneL <- c(0.15, 0.25, 0.3, 0.25, 0.05)
  afAlOneL <- 11:15
...
test_that("kinLike2 IBS = 2 pattern 2", {
  qgt <- c(11, 12)
  rgt <- c(11, 12)
  afOneL <- c(0.15, 0.25, 0.3, 0.25, 0.05)
  afAlOneL <- 11:15
...
test_that("kinLike2 mutation pattern 1", {
  qgt <- c(11, 12)
  rgt <- c(13, 14)
  afOneL <- c(0.15, 0.25, 0.3, 0.25, 0.05)
  afAlOneL <- 11:15
...
test_that("kinLike2 mutation pattern 2", {
  qgt <- c(11, 12)
  rgt <- c(12, 14)
  afOneL <- c(0.15, 0.25, 0.3, 0.25, 0.05)
  afAlOneL <- 11:15
